...
import app_pic_1 from "../../styles/images/app-pic-1.png";
import app_pic_2 from "../../styles/images/app-pic-2.png";
import app_pic_3 from "../../styles/images/app-pic-3.png";
import app_pic_4 from "../../styles/images/app-pic-4.png";
import image_website_creative from "../../styles/images/website-creative.png";
import image_website_creative_top from "../../styles/images/website-creative-top.png";
import image_website_creative_bottom from "../../styles/images/website-creative-bottom.png";
...
const FindMore = ({
  ...
  return (
    <div className="find-more">
      ...
      {/* //? Header */}
      {/* <div className="find-more__header">
        <div className="head">
      ...
      />
      {/* //? 1st blue section */}
      <div className="find-more__hero">
        <div className="find-more__hero--section-1">
        ...
        <div
          className="find-more__hero--section-3"
      ...
      <div className="find-more__insight">
        <div className="find-more__insight--head">
          <div className="heading">
        ...
        <div className="find-more__insight--body">
          {/* //? nav buttons */}
      ...
      {/* //? 3rd grey section */}
      <div className="find-more__number-section">
        <div className="find-more__number-section--head">
          <div className="text">Data, insight and action</div>
        </div>
        <div className="find-more__number-section--body">
      ...
      <div className="find-more__services">
        <div className="find-more__services--head">
          <div className="heading">
        ...
        <div className="find-more__services--body">
          <div className="logo">
      ...
      {/* //? 5th grey section */}
      <div className="find-more__outcomes">
        <div className="find-more__outcomes--head">
          <div className="heading">
            How do we know,
            <br />
            it's working?
        ...
        <div className="find-more__outcomes--body outcome-items">
        ...
        {/* <div className="find-more__outcomes--explore-link">
          <div className="link-btn">Read the ROI Report</div>
        </div> */}
      </div>

      {/* //? 6th white section */}
      <div className="find-more__ecosystem">
        <div className="find-more__ecosystem--head">
          <div className="heading">
        ...
        <div className="find-more__ecosystem--body ecosystem-items">
          <div className="item item-1">
            <div className="icon">
              <SiSwiggy size={50} />
            </div>
      ...
      {/* //? 7th cards */}
      <div className="find-more__banners">
      ...
      {/* //? 8th bottom section */}
      <div className="find-more__bottom-section">
        <div className="find-more__bottom-section--head">
        ...
        <div className="find-more__bottom-section--body">
        ...
        <div className="find-more__bottom-section--bottom">
          <div className="text">
          ...
          {/* <div className="privacy-text">
            ©2022 find-more, Inc. All rights reserved. find-more is a registered
            trademark of find-more, Inc.
          </div> */}
          {/* <div className="links">
